...
namespace Common.Logging.Simple
{
    ...
    public class ConsoleOutLoggerFactoryAdapter : Simple.AbstractSimpleLoggerFactoryAdapter
    {
        ...
        /// default settings for the loggers created by this factory.
        /// </summary>
        /// <param name="level">输出的最小日志级别</param>
        /// <param name="showDateTime">是否显示日期</param>
        /// <param name="showLogName">是否显示日志文件名称</param>
        /// <param name="showLevel">是否显示日志级别</param>
        /// <param name="dateTimeFormat">格式化字符串</param>
        /// <param name="useColor">是否根据日志级别显示相应的颜色</param>
